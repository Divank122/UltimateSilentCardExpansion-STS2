...
public class Balance : SilentCardModel
{
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        await PowerCmd.Apply<DrawCardsNextTurnPower>(Owner.Creature, cardsToDraw, Owner.Creature, this);

        if (Owner.Creature.GetPower<BalancePower>() == null)
        {
            await PowerCmd.Apply<BalancePower>(Owner.Creature, 1, Owner.Creature, this);
        }
    }
    ...
    public override async Task BeforeCombatStart()
    {
        ...
        {
            await PowerCmd.Apply<DriftingPower>(Owner.Creature, 1, Owner.Creature, this);
        }
    }
